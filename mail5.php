...
$sql2 = "SELECT TEAMID FROM student1 WHERE GUIDEID='".$guideid['GUIDEID']."'";
$result2=mysqli_query($conn, $sql2);
//$teamids = mysqli_fetch_array($result2,MYSQLI_ASSOC);
$a=mysqli_num_rows($result2);
echo "<html><body><form action='http://localhost/myprojects/working_php_code_promas/mail7.php' method='post'>
...
{
	$teamids = mysqli_fetch_array($result2,MYSQLI_ASSOC);
	echo "<option value='".$teamids['TEAMID']."'>'".$teamids['TEAMID']."'</option>";
	$count += 1;
}
echo "<br><br>
